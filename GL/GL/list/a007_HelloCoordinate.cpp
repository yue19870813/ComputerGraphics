...
const char *fragmentShader007Source = "#version 330 core\n"
    "out vec4 FragColor;\n"
    "in vec3 ourColor;\n"
    "in vec2 TexCoord;\n"
...
int a007_helloCoordinate() {
    ...
    // 编译shader
    Shader ourShader(vertexShader007Source, fragmentShader007Source);
...
const char *vertexShader007MoreSource = "#version 330 core\n"
    "layout (location = 0) in vec3 aPos;\n"
...
const char *fragmentShader007MoreSource = "#version 330 core\n"
    "out vec4 FragColor;\n"
    "in vec2 TexCoord;\n"
    "uniform sampler2D texture1;\n"
    "uniform sampler2D texture2;\n"
...
int a007_more3D() {
    ...
    GLFWwindow *window = glfw.init();
    // 编译shader
    Shader ourShader(vertexShader007MoreSource, fragmentShader007MoreSource);
...
int a007_testProjection() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view  = glm::translate(view, glm::vec3(0.0f, 0.0f, -3.0f));
        projection = glm::perspective(glm::radians(60.0f), ((float)SCR_WIDTH) / ((float)SCR_HEIGHT + 400), 0.1f, 100.0f);
