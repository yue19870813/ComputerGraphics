...
const char *vertexShader006Source = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   gl_Position = gl_Position = transform * vec4(aPos, 1.0f);\n"
    "   ourColor = aColor;\n"
    "   TexCoord = aTexCoord;\n"
    "}\0";

const char *fragmentShader006Source = "#version 330 core\n"
    "out vec4 FragColor;\n"
    "in vec3 ourColor;\n"
    "in vec2 TexCoord;\n"
...
int a006_helloTransform() {
    ...
    // 编译shader
    Shader ourShader(vertexShader006Source, fragmentShader006Source);
...
//    glUniform1i(glGetUniformLocation(ourShader.ID, "texture1"), 0);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // 第一个参数是变换矩阵；第二个参数是弧度；第三个参数是沿z轴旋转
